"""
Unit tests `cappr._utils.classify`.
"""
...
from cappr._utils import classify
...
def test_agg_log_probs_from_constant_completions():
    log_probs = [[[2, 2], [1]], [[1 / 2, 1 / 2], [4]]]
    log_probs_agg = classify.agg_log_probs_from_constant_completions(
