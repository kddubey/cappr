...
def test_wraps_but_keep_wrapper_return_ann():
    ...
    ## Need to do this jankyness b/c I want to test that the wrapped function's
    ## name is preserved. Without these references, sum_numbers can only refer
    ## to the wrapped function below. 
    ...
    assert name_to_func['wrapped'](-1, 2, 3) is True
    assert name_to_func['wrapped'](-1, 1, 0) is False
