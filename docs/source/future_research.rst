...
from machine learning is that good probability estimation des not necessarily imply good
discrimination.  Perhaps there are untapped, smaller, or undertrained models which are
good at estimation, but not good at discrimination.
